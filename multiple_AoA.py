# -*- coding: utf-8 -*-
"""
Created on Sat Feb 13 10:42:17 2021
...
midspan_chord=0.07
midspan_Cl=6.8038
midspan_incidence_arr=np.linspace(0,12,13)
...
for segment in n:
    for midspan_incidence in midspan_incidence_arr:
    	print("----------THIS IS FOR "+str(midspan_incidence)+" AoA ----------------")
...
plt.plot(midspan_incidence_arr,Cl_arr,linestyle='dashed',marker='.',label='coefficient of Lift vs AoA')
plt.xlabel=('Angle of Attack (degree)')
plt.ylabel('Coefficient of Lift')
plt.legend()
plt.savefig('Cl_vs_AoA.png')
plt.close()

plt.plot(midspan_incidence_arr,Cd_arr,linestyle='dashed',marker='.',label='coefficient of Drag vs AoA')
plt.xlabel=('Angle of Attack (degree)')
plt.ylabel('Coefficient of Drag')
plt.legend()
plt.savefig('Cd_vs_AoA.png')
